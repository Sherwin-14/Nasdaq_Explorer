...
Our stock prediction tool utilizes machine learning techniques to analyze and forecast time series data. Currently, we onl support  XGBoost, a powerful and efficient algorithm for handling complex time series data. 
