...
Our stock prediction tool utilizes machine learning techniques to analyze and forecast time series data. Currently, we only support  XGBoost but we are planning to add more in the upcoming versions. 
